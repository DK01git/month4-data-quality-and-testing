"""
Month 4 — Build, save, and validate the fact_sales expectation suite.

Run from:  C:\\de-training\\month4
Command:   python scripts/03_build_fact_sales.py
"""
...
from suites import fact_sales_suite as suite_mod


DATASOURCE_NAME = "retail_warehouse_dq"
ASSET_NAME = "fact_sales"
BATCH_DEF_NAME = "fact_sales_whole_table"
...
def main() -> None:
    ...
    print("(Note: 500K-row table — allow ~5-15 seconds for orphan-check JOINs)")
    print("-" * 72)
