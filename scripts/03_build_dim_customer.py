"""
Month 4 — Build, save, and validate the dim_customer expectation suite.

Run from:  C:\\de-training\\month4
Command:   python scripts/03_build_dim_customer.py
"""
...
# Make scripts/ importable so we can pull suite modules from suites/
PROJECT_ROOT = Path(__file__).resolve().parent.parent
SCRIPTS_DIR = PROJECT_ROOT / "scripts"
if str(SCRIPTS_DIR) not in sys.path:
    sys.path.insert(0, str(SCRIPTS_DIR))

from suites import dim_customer_suite as suite_mod


DATASOURCE_NAME = "retail_warehouse_dq"
ASSET_NAME = "dim_customer"
BATCH_DEF_NAME = "dim_customer_whole_table"
...
def main() -> None:
    ...
    # ---------- Build / upsert validation definition ----------
