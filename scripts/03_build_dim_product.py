"""
Month 4 — Build, save, and validate the dim_product expectation suite.

Run from:  C:\\de-training\\month4
Command:   python scripts/03_build_dim_product.py
"""
...
from suites import dim_product_suite as suite_mod


DATASOURCE_NAME = "retail_warehouse_dq"
ASSET_NAME = "dim_product"
BATCH_DEF_NAME = "dim_product_whole_table"
